export default class articleFormsHandler {
    ...
    assignFormAndArticle(formElementId, cssClass2hideElement, articleId, offset, totalCount, /*sort, pageCount*/){
        ...
        if(articleId >= 0){
            ...
            artForm.onsubmit = (event)=>this.processArtInsertFromData(event);
            this.articleId = articleId;
            this.offset = offset;
            this.totalCount = totalCount;
        }
    ...
    processArtEditFrmData(event){
       ...
       /* console.log(articleData.tags.length);
        let index = articleData.tags.length
        articleData.tags[index] = 'sluchadla'
